...
static const _BasicTypes_Event_type_support_symbol_names_t _BasicTypes_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_msgs, srv, BasicTypes_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_msgs, srv, BasicTypes_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, test_msgs, srv, BasicTypes_Event)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, test_msgs, srv, BasicTypes_Event)() {
  return &::test_msgs::srv::rosidl_typesupport_c::BasicTypes_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t BasicTypes_service_type_support_handle = {
  ...
  &BasicTypes_Request_message_type_support_handle,
  &BasicTypes_Response_message_type_support_handle,
  &BasicTypes_Event_message_type_support_handle,
