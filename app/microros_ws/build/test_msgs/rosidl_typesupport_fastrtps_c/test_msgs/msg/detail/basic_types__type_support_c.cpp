  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const test_msgs__msg__BasicTypes * ros_message = static_cast<const test_msgs__msg__BasicTypes *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_test_msgs__msg__BasicTypes(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  test_msgs__msg__BasicTypes * ros_message = static_cast<test_msgs__msg__BasicTypes *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_test_msgs__msg__BasicTypes(cdr, ros_message);
}
