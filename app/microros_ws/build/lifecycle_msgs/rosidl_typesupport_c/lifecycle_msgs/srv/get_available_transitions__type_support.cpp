...
static const _GetAvailableTransitions_Event_type_support_symbol_names_t _GetAvailableTransitions_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lifecycle_msgs, srv, GetAvailableTransitions_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lifecycle_msgs, srv, GetAvailableTransitions_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, lifecycle_msgs, srv, GetAvailableTransitions_Event)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lifecycle_msgs, srv, GetAvailableTransitions_Event)() {
  return &::lifecycle_msgs::srv::rosidl_typesupport_c::GetAvailableTransitions_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetAvailableTransitions_service_type_support_handle = {
  ...
  &GetAvailableTransitions_Request_message_type_support_handle,
  &GetAvailableTransitions_Response_message_type_support_handle,
  &GetAvailableTransitions_Event_message_type_support_handle,
