  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const statistics_msgs__msg__StatisticDataPoint * ros_message = static_cast<const statistics_msgs__msg__StatisticDataPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_statistics_msgs__msg__StatisticDataPoint(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  statistics_msgs__msg__StatisticDataPoint * ros_message = static_cast<statistics_msgs__msg__StatisticDataPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_statistics_msgs__msg__StatisticDataPoint(cdr, ros_message);
}
