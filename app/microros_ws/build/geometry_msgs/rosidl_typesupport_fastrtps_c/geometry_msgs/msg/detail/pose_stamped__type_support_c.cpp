  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const geometry_msgs__msg__PoseStamped * ros_message = static_cast<const geometry_msgs__msg__PoseStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_geometry_msgs__msg__PoseStamped(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  geometry_msgs__msg__PoseStamped * ros_message = static_cast<geometry_msgs__msg__PoseStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_geometry_msgs__msg__PoseStamped(cdr, ros_message);
}
