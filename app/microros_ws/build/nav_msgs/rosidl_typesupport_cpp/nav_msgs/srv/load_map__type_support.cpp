...
static const _LoadMap_Event_type_support_symbol_names_t _LoadMap_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav_msgs, srv, LoadMap_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nav_msgs, srv, LoadMap_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, nav_msgs, srv, LoadMap_Event)),
  }
};
...
{
  return &::nav_msgs::srv::rosidl_typesupport_cpp::LoadMap_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nav_msgs, srv, LoadMap_Event)() {
  return get_message_type_support_handle<nav_msgs::srv::LoadMap_Event>();
}
...
static const rosidl_service_type_support_t LoadMap_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<nav_msgs::srv::LoadMap_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<nav_msgs::srv::LoadMap_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<nav_msgs::srv::LoadMap_Event>(),
