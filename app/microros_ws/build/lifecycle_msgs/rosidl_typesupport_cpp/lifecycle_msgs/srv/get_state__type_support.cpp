...
static const _GetState_Event_type_support_symbol_names_t _GetState_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lifecycle_msgs, srv, GetState_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lifecycle_msgs, srv, GetState_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, lifecycle_msgs, srv, GetState_Event)),
  }
};
...
{
  return &::lifecycle_msgs::srv::rosidl_typesupport_cpp::GetState_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetState_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<lifecycle_msgs::srv::GetState_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<lifecycle_msgs::srv::GetState_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<lifecycle_msgs::srv::GetState_Event>(),
