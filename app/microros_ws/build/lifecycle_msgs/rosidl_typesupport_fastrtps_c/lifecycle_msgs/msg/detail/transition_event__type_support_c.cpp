  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const lifecycle_msgs__msg__TransitionEvent * ros_message = static_cast<const lifecycle_msgs__msg__TransitionEvent *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_lifecycle_msgs__msg__TransitionEvent(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  lifecycle_msgs__msg__TransitionEvent * ros_message = static_cast<lifecycle_msgs__msg__TransitionEvent *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_lifecycle_msgs__msg__TransitionEvent(cdr, ros_message);
}
