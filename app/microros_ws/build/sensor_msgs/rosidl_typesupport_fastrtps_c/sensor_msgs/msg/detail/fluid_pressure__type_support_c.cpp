  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sensor_msgs__msg__FluidPressure * ros_message = static_cast<const sensor_msgs__msg__FluidPressure *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sensor_msgs__msg__FluidPressure(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sensor_msgs__msg__FluidPressure * ros_message = static_cast<sensor_msgs__msg__FluidPressure *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sensor_msgs__msg__FluidPressure(cdr, ros_message);
}
...
static size_t _FluidPressure__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sensor_msgs__msg__FluidPressure(
