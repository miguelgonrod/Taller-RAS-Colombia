  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const example_interfaces__msg__Empty * ros_message = static_cast<const example_interfaces__msg__Empty *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_example_interfaces__msg__Empty(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  example_interfaces__msg__Empty * ros_message = static_cast<example_interfaces__msg__Empty *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_example_interfaces__msg__Empty(cdr, ros_message);
}
