...
static const _Empty_Event_type_support_symbol_names_t _Empty_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, std_srvs, srv, Empty_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, std_srvs, srv, Empty_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, std_srvs, srv, Empty_Event)),
  }
};
...
{
  return &::std_srvs::srv::rosidl_typesupport_cpp::Empty_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, std_srvs, srv, Empty_Event)() {
  return get_message_type_support_handle<std_srvs::srv::Empty_Event>();
}
...
static const rosidl_service_type_support_t Empty_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<std_srvs::srv::Empty_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<std_srvs::srv::Empty_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<std_srvs::srv::Empty_Event>(),
