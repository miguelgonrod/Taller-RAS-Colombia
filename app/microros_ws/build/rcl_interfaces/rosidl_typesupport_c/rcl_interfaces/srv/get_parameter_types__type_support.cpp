...
static const _GetParameterTypes_Event_type_support_symbol_names_t _GetParameterTypes_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rcl_interfaces, srv, GetParameterTypes_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcl_interfaces, srv, GetParameterTypes_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, rcl_interfaces, srv, GetParameterTypes_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rcl_interfaces, srv, GetParameterTypes_Event)() {
  return &::rcl_interfaces::srv::rosidl_typesupport_c::GetParameterTypes_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetParameterTypes_service_type_support_handle = {
  ...
  &GetParameterTypes_Request_message_type_support_handle,
  &GetParameterTypes_Response_message_type_support_handle,
  &GetParameterTypes_Event_message_type_support_handle,
