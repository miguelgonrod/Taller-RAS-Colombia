  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geometry_msgs__msg__Pose2D;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const geometry_msgs__msg__Pose2D * ros_message = static_cast<const geometry_msgs__msg__Pose2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_geometry_msgs__msg__Pose2D(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  geometry_msgs__msg__Pose2D * ros_message = static_cast<geometry_msgs__msg__Pose2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_geometry_msgs__msg__Pose2D(cdr, ros_message);
}
