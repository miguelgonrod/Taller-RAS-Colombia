  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: accel
  {
    cdr_serialize_geometry_msgs__msg__AccelWithCovariance(
  ...
  geometry_msgs__msg__AccelWithCovarianceStamped * ros_message)
{
  ...
  // Field name: accel
  {
    cdr_deserialize_geometry_msgs__msg__AccelWithCovariance(cdr, &ros_message->accel);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: accel
  {
    cdr_serialize_key_geometry_msgs__msg__AccelWithCovariance(
      &ros_message->accel, cdr);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: accel
  current_alignment += get_serialized_size_key_geometry_msgs__msg__AccelWithCovariance(
    &(ros_message->accel), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Field name: accel
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_geometry_msgs__msg__AccelWithCovariance(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const geometry_msgs__msg__AccelWithCovarianceStamped * ros_message = static_cast<const geometry_msgs__msg__AccelWithCovarianceStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_geometry_msgs__msg__AccelWithCovarianceStamped(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  geometry_msgs__msg__AccelWithCovarianceStamped * ros_message = static_cast<geometry_msgs__msg__AccelWithCovarianceStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_geometry_msgs__msg__AccelWithCovarianceStamped(cdr, ros_message);
}
