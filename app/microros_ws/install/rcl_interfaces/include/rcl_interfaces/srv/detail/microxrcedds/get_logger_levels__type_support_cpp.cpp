...
#include "rcl_interfaces/srv/detail/get_logger_levels__rosidl_typesupport_microxrcedds_cpp.hpp"
...
static size_t _GetLoggerLevels_Request__get_serialized_size_with_initial_alignment(
...
{
  bool full_bounded;
  return max_serialized_size_GetLoggerLevels_Request(&full_bounded, 0);
}
...
static message_type_support_callbacks_t _GetLoggerLevels_Request__callbacks = {
  ...
  _GetLoggerLevels_Request__get_serialized_size_with_initial_alignment,
...
{
  return &rcl_interfaces::srv::typesupport_microxrcedds_cpp::_GetLoggerLevels_Request__handle;
}
...
static size_t _GetLoggerLevels_Response__get_serialized_size_with_initial_alignment(
  const void * untyped_ros_message, size_t current_alignment)
{
  auto typed_message =
    static_cast<const rcl_interfaces::srv::GetLoggerLevels_Response *>(
...
{
  bool full_bounded;
  return max_serialized_size_GetLoggerLevels_Response(&full_bounded, 0);
}
...
static message_type_support_callbacks_t _GetLoggerLevels_Response__callbacks = {
  ...
  _GetLoggerLevels_Response__get_serialized_size_with_initial_alignment,
...
{
  return &rcl_interfaces::srv::typesupport_microxrcedds_cpp::_GetLoggerLevels_Response__handle;
}
...
{
  return &rcl_interfaces::srv::typesupport_microxrcedds_cpp::_GetLoggerLevels__handle;
}
