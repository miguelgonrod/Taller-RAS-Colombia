  ...
  rcl_interfaces__msg__Parameter * ros_message)
{
  ...
  // Field name: value
  {
    cdr_deserialize_rcl_interfaces__msg__ParameterValue(cdr, &ros_message->value);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rcl_interfaces__msg__Parameter * ros_message = static_cast<const rcl_interfaces__msg__Parameter *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rcl_interfaces__msg__Parameter(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rcl_interfaces__msg__Parameter * ros_message = static_cast<rcl_interfaces__msg__Parameter *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rcl_interfaces__msg__Parameter(cdr, ros_message);
}
