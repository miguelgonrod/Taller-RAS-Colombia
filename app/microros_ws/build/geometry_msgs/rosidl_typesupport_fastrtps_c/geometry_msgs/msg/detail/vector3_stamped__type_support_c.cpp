  ...
  geometry_msgs__msg__Vector3Stamped * ros_message)
{
  ...
  // Field name: vector
  {
    cdr_deserialize_geometry_msgs__msg__Vector3(cdr, &ros_message->vector);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const geometry_msgs__msg__Vector3Stamped * ros_message = static_cast<const geometry_msgs__msg__Vector3Stamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_geometry_msgs__msg__Vector3Stamped(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  geometry_msgs__msg__Vector3Stamped * ros_message = static_cast<geometry_msgs__msg__Vector3Stamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_geometry_msgs__msg__Vector3Stamped(cdr, ros_message);
}
