...
static const _DescribeParameters_Event_type_support_symbol_names_t _DescribeParameters_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rcl_interfaces, srv, DescribeParameters_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcl_interfaces, srv, DescribeParameters_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, rcl_interfaces, srv, DescribeParameters_Event)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rcl_interfaces, srv, DescribeParameters_Event)() {
  return &::rcl_interfaces::srv::rosidl_typesupport_c::DescribeParameters_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t DescribeParameters_service_type_support_handle = {
  ...
  &DescribeParameters_Request_message_type_support_handle,
  &DescribeParameters_Response_message_type_support_handle,
  &DescribeParameters_Event_message_type_support_handle,
