...
static const _SetCameraInfo_Event_type_support_symbol_names_t _SetCameraInfo_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sensor_msgs, srv, SetCameraInfo_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sensor_msgs, srv, SetCameraInfo_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, sensor_msgs, srv, SetCameraInfo_Event)),
  }
};
...
{
  return &::sensor_msgs::srv::rosidl_typesupport_cpp::SetCameraInfo_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sensor_msgs, srv, SetCameraInfo_Event)() {
  return get_message_type_support_handle<sensor_msgs::srv::SetCameraInfo_Event>();
}
...
static const rosidl_service_type_support_t SetCameraInfo_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<sensor_msgs::srv::SetCameraInfo_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<sensor_msgs::srv::SetCameraInfo_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<sensor_msgs::srv::SetCameraInfo_Event>(),
