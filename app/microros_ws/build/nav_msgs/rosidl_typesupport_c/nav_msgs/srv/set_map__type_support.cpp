...
static const _SetMap_Event_type_support_symbol_names_t _SetMap_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nav_msgs, srv, SetMap_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav_msgs, srv, SetMap_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, nav_msgs, srv, SetMap_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nav_msgs, srv, SetMap_Event)() {
  return &::nav_msgs::srv::rosidl_typesupport_c::SetMap_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SetMap_service_type_support_handle = {
  ...
  &SetMap_Request_message_type_support_handle,
  &SetMap_Response_message_type_support_handle,
  &SetMap_Event_message_type_support_handle,
