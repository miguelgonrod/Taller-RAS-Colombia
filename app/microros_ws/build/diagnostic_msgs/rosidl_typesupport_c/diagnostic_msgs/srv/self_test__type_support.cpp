...
static const _SelfTest_Event_type_support_symbol_names_t _SelfTest_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, diagnostic_msgs, srv, SelfTest_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, diagnostic_msgs, srv, SelfTest_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, diagnostic_msgs, srv, SelfTest_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, diagnostic_msgs, srv, SelfTest_Event)() {
  return &::diagnostic_msgs::srv::rosidl_typesupport_c::SelfTest_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SelfTest_service_type_support_handle = {
  ...
  &SelfTest_Request_message_type_support_handle,
  &SelfTest_Response_message_type_support_handle,
  &SelfTest_Event_message_type_support_handle,
