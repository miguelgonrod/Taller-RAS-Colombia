  ...
  geometry_msgs__msg__Transform * ros_message)
{
  ...
  // Field name: rotation
  {
    cdr_deserialize_geometry_msgs__msg__Quaternion(cdr, &ros_message->rotation);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const geometry_msgs__msg__Transform * ros_message = static_cast<const geometry_msgs__msg__Transform *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_geometry_msgs__msg__Transform(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  geometry_msgs__msg__Transform * ros_message = static_cast<geometry_msgs__msg__Transform *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_geometry_msgs__msg__Transform(cdr, ros_message);
}
