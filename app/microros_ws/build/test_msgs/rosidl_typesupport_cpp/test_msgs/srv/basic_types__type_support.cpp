...
typedef struct _BasicTypes_Event_type_support_ids_t
{
  const char * typesupport_identifier[3];
} _BasicTypes_Event_type_support_ids_t;

static const _BasicTypes_Event_type_support_ids_t _BasicTypes_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_cpp",  // ::rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
    "rosidl_typesupport_introspection_cpp",  // ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
    "rosidl_typesupport_microxrcedds_cpp",  // ::rosidl_typesupport_microxrcedds_cpp::typesupport_identifier,
...
typedef struct _BasicTypes_Event_type_support_symbol_names_t
{
  const char * symbol_name[3];
} _BasicTypes_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _BasicTypes_Event_type_support_symbol_names_t _BasicTypes_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_msgs, srv, BasicTypes_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_msgs, srv, BasicTypes_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, test_msgs, srv, BasicTypes_Event)),
  }
};

typedef struct _BasicTypes_Event_type_support_data_t
{
  void * data[3];
} _BasicTypes_Event_type_support_data_t;

static _BasicTypes_Event_type_support_data_t _BasicTypes_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
    0,  // will store the shared library later
...
static const type_support_map_t _BasicTypes_Event_message_typesupport_map = {
  3,
  "test_msgs",
  &_BasicTypes_Event_message_typesupport_ids.typesupport_identifier[0],
  &_BasicTypes_Event_message_typesupport_symbol_names.symbol_name[0],
  &_BasicTypes_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t BasicTypes_Event_message_type_support_handle = {
  ::rosidl_typesupport_cpp::typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_BasicTypes_Event_message_typesupport_map),
  ::rosidl_typesupport_cpp::get_message_typesupport_handle_function,
...
{
  return &::test_msgs::srv::rosidl_typesupport_cpp::BasicTypes_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, test_msgs, srv, BasicTypes_Event)() {
  return get_message_type_support_handle<test_msgs::srv::BasicTypes_Event>();
}
...
static const rosidl_service_type_support_t BasicTypes_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<test_msgs::srv::BasicTypes_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<test_msgs::srv::BasicTypes_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<test_msgs::srv::BasicTypes_Event>(),
