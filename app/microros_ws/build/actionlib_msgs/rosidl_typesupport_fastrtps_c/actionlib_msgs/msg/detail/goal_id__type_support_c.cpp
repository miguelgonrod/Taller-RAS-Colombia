  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = actionlib_msgs__msg__GoalID;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const actionlib_msgs__msg__GoalID * ros_message = static_cast<const actionlib_msgs__msg__GoalID *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_actionlib_msgs__msg__GoalID(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  actionlib_msgs__msg__GoalID * ros_message = static_cast<actionlib_msgs__msg__GoalID *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_actionlib_msgs__msg__GoalID(cdr, ros_message);
}
