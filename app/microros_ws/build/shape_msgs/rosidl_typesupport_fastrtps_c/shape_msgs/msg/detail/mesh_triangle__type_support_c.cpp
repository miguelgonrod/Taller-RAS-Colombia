  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const shape_msgs__msg__MeshTriangle * ros_message = static_cast<const shape_msgs__msg__MeshTriangle *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_shape_msgs__msg__MeshTriangle(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  shape_msgs__msg__MeshTriangle * ros_message = static_cast<shape_msgs__msg__MeshTriangle *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_shape_msgs__msg__MeshTriangle(cdr, ros_message);
}
...
static size_t _MeshTriangle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_shape_msgs__msg__MeshTriangle(
