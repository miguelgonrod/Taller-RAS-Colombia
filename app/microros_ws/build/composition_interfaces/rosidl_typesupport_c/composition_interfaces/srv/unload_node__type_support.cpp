...
static const _UnloadNode_Event_type_support_symbol_names_t _UnloadNode_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, composition_interfaces, srv, UnloadNode_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, composition_interfaces, srv, UnloadNode_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, composition_interfaces, srv, UnloadNode_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, composition_interfaces, srv, UnloadNode_Event)() {
  return &::composition_interfaces::srv::rosidl_typesupport_c::UnloadNode_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t UnloadNode_service_type_support_handle = {
  ...
  &UnloadNode_Request_message_type_support_handle,
  &UnloadNode_Response_message_type_support_handle,
  &UnloadNode_Event_message_type_support_handle,
