  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: statistics
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_statistics_msgs__msg__StatisticDataPoint(
        &array_ptr[i], cdr);
    }
  }
  ...
  statistics_msgs__msg__MetricsMessage * ros_message)
{
  ...
  // Field name: window_start
  {
    cdr_deserialize_builtin_interfaces__msg__Time(cdr, &ros_message->window_start);
  }

  // Field name: window_stop
  {
    cdr_deserialize_builtin_interfaces__msg__Time(cdr, &ros_message->window_stop);
  }
  ...
  // Field name: statistics
  {
    ...
    auto array_ptr = ros_message->statistics.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_statistics_msgs__msg__StatisticDataPoint(cdr, &array_ptr[i]);
    }
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: statistics
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_statistics_msgs__msg__StatisticDataPoint(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: statistics
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_statistics_msgs__msg__StatisticDataPoint(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: statistics
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_statistics_msgs__msg__StatisticDataPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const statistics_msgs__msg__MetricsMessage * ros_message = static_cast<const statistics_msgs__msg__MetricsMessage *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_statistics_msgs__msg__MetricsMessage(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  statistics_msgs__msg__MetricsMessage * ros_message = static_cast<statistics_msgs__msg__MetricsMessage *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_statistics_msgs__msg__MetricsMessage(cdr, ros_message);
}
