...
static const _LoadNode_Event_type_support_symbol_names_t _LoadNode_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, composition_interfaces, srv, LoadNode_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, composition_interfaces, srv, LoadNode_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, composition_interfaces, srv, LoadNode_Event)),
  }
};
...
{
  return &::composition_interfaces::srv::rosidl_typesupport_cpp::LoadNode_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, composition_interfaces, srv, LoadNode_Event)() {
  return get_message_type_support_handle<composition_interfaces::srv::LoadNode_Event>();
}
...
static const rosidl_service_type_support_t LoadNode_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<composition_interfaces::srv::LoadNode_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<composition_interfaces::srv::LoadNode_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<composition_interfaces::srv::LoadNode_Event>(),
