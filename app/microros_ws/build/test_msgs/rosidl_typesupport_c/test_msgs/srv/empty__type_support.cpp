...
static const _Empty_Event_type_support_symbol_names_t _Empty_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_msgs, srv, Empty_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_msgs, srv, Empty_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, test_msgs, srv, Empty_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, test_msgs, srv, Empty_Event)() {
  return &::test_msgs::srv::rosidl_typesupport_c::Empty_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t Empty_service_type_support_handle = {
  ...
  &Empty_Response_message_type_support_handle,
  &Empty_Event_message_type_support_handle,
