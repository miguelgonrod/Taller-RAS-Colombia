  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: data14
  complex_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
    ros_message.data14,
    cdr);
  ...
  size_t current_alignment)
{
  ...
  // Member: data14
  current_alignment +=
    complex_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
    ros_message.data14, current_alignment);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_complex_msgs
max_serialized_size_key_NestedMsgTest(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: data14
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        complex_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_MultiStringTest(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
