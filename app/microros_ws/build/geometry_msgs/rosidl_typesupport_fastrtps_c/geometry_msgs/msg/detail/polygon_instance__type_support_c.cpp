  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const geometry_msgs__msg__PolygonInstance * ros_message = static_cast<const geometry_msgs__msg__PolygonInstance *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_geometry_msgs__msg__PolygonInstance(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  geometry_msgs__msg__PolygonInstance * ros_message = static_cast<geometry_msgs__msg__PolygonInstance *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_geometry_msgs__msg__PolygonInstance(cdr, ros_message);
}
...
static size_t _PolygonInstance__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_geometry_msgs__msg__PolygonInstance(
