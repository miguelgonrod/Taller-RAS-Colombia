  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: polygon
  {
    cdr_serialize_geometry_msgs__msg__PolygonInstance(
  ...
  geometry_msgs__msg__PolygonInstanceStamped * ros_message)
{
  ...
  // Field name: polygon
  {
    cdr_deserialize_geometry_msgs__msg__PolygonInstance(cdr, &ros_message->polygon);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: polygon
  current_alignment += get_serialized_size_geometry_msgs__msg__PolygonInstance(
  ...
  size_t current_alignment)
{
  ...
  // Field name: polygon
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_geometry_msgs__msg__PolygonInstance(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: polygon
  {
    cdr_serialize_key_geometry_msgs__msg__PolygonInstance(
      &ros_message->polygon, cdr);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: polygon
  current_alignment += get_serialized_size_key_geometry_msgs__msg__PolygonInstance(
    &(ros_message->polygon), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Field name: polygon
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_geometry_msgs__msg__PolygonInstance(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const geometry_msgs__msg__PolygonInstanceStamped * ros_message = static_cast<const geometry_msgs__msg__PolygonInstanceStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_geometry_msgs__msg__PolygonInstanceStamped(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  geometry_msgs__msg__PolygonInstanceStamped * ros_message = static_cast<geometry_msgs__msg__PolygonInstanceStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_geometry_msgs__msg__PolygonInstanceStamped(cdr, ros_message);
}
...
static size_t _PolygonInstanceStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_geometry_msgs__msg__PolygonInstanceStamped(
