  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: inertia
  {
    cdr_serialize_geometry_msgs__msg__Inertia(
  ...
  geometry_msgs__msg__InertiaStamped * ros_message)
{
  ...
  // Field name: inertia
  {
    cdr_deserialize_geometry_msgs__msg__Inertia(cdr, &ros_message->inertia);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: inertia
  {
    cdr_serialize_key_geometry_msgs__msg__Inertia(
      &ros_message->inertia, cdr);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: inertia
  current_alignment += get_serialized_size_key_geometry_msgs__msg__Inertia(
    &(ros_message->inertia), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Field name: inertia
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_geometry_msgs__msg__Inertia(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const geometry_msgs__msg__InertiaStamped * ros_message = static_cast<const geometry_msgs__msg__InertiaStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_geometry_msgs__msg__InertiaStamped(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  geometry_msgs__msg__InertiaStamped * ros_message = static_cast<geometry_msgs__msg__InertiaStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_geometry_msgs__msg__InertiaStamped(cdr, ros_message);
}
