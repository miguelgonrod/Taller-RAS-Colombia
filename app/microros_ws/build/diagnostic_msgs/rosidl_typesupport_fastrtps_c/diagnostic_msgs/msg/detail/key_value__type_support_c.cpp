  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const diagnostic_msgs__msg__KeyValue * ros_message = static_cast<const diagnostic_msgs__msg__KeyValue *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_diagnostic_msgs__msg__KeyValue(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  diagnostic_msgs__msg__KeyValue * ros_message = static_cast<diagnostic_msgs__msg__KeyValue *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_diagnostic_msgs__msg__KeyValue(cdr, ros_message);
}
...
static size_t _KeyValue__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_diagnostic_msgs__msg__KeyValue(
