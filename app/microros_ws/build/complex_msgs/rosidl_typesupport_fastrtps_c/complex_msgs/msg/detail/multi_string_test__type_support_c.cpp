  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const complex_msgs__msg__MultiStringTest * ros_message = static_cast<const complex_msgs__msg__MultiStringTest *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_complex_msgs__msg__MultiStringTest(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  complex_msgs__msg__MultiStringTest * ros_message = static_cast<complex_msgs__msg__MultiStringTest *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_complex_msgs__msg__MultiStringTest(cdr, ros_message);
}
