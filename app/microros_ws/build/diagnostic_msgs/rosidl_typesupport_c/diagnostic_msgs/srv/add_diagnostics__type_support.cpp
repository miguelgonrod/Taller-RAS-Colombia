...
static const _AddDiagnostics_Event_type_support_symbol_names_t _AddDiagnostics_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, diagnostic_msgs, srv, AddDiagnostics_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, diagnostic_msgs, srv, AddDiagnostics_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, diagnostic_msgs, srv, AddDiagnostics_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, diagnostic_msgs, srv, AddDiagnostics_Event)() {
  return &::diagnostic_msgs::srv::rosidl_typesupport_c::AddDiagnostics_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t AddDiagnostics_service_type_support_handle = {
  ...
  &AddDiagnostics_Request_message_type_support_handle,
  &AddDiagnostics_Response_message_type_support_handle,
  &AddDiagnostics_Event_message_type_support_handle,
