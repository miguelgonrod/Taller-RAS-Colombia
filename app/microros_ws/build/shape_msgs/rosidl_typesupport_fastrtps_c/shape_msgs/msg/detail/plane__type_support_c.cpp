  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const shape_msgs__msg__Plane * ros_message = static_cast<const shape_msgs__msg__Plane *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_shape_msgs__msg__Plane(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  shape_msgs__msg__Plane * ros_message = static_cast<shape_msgs__msg__Plane *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_shape_msgs__msg__Plane(cdr, ros_message);
}
