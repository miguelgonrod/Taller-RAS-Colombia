  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const example_interfaces__msg__MultiArrayDimension * ros_message = static_cast<const example_interfaces__msg__MultiArrayDimension *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_example_interfaces__msg__MultiArrayDimension(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  example_interfaces__msg__MultiArrayDimension * ros_message = static_cast<example_interfaces__msg__MultiArrayDimension *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_example_interfaces__msg__MultiArrayDimension(cdr, ros_message);
}
