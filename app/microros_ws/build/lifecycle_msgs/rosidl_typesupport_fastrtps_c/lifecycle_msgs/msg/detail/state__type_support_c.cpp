  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const lifecycle_msgs__msg__State * ros_message = static_cast<const lifecycle_msgs__msg__State *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_lifecycle_msgs__msg__State(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  lifecycle_msgs__msg__State * ros_message = static_cast<lifecycle_msgs__msg__State *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_lifecycle_msgs__msg__State(cdr, ros_message);
}
