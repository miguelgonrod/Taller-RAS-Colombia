...
static const _Arrays_Request_type_support_symbol_names_t _Arrays_Request_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, test_msgs, srv, Arrays_Request)),
  }
};
...
static const _Arrays_Response_type_support_symbol_names_t _Arrays_Response_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, test_msgs, srv, Arrays_Response)),
  }
};
...
static const _Arrays_Event_type_support_symbol_names_t _Arrays_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_msgs, srv, Arrays_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_msgs, srv, Arrays_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, test_msgs, srv, Arrays_Event)),
  }
};
...
{
  return &::test_msgs::srv::rosidl_typesupport_cpp::Arrays_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, test_msgs, srv, Arrays_Event)() {
  return get_message_type_support_handle<test_msgs::srv::Arrays_Event>();
}
...
static const _Arrays_type_support_symbol_names_t _Arrays_service_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, test_msgs, srv, Arrays)),
  }
};
...
static const rosidl_service_type_support_t Arrays_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<test_msgs::srv::Arrays_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<test_msgs::srv::Arrays_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<test_msgs::srv::Arrays_Event>(),
