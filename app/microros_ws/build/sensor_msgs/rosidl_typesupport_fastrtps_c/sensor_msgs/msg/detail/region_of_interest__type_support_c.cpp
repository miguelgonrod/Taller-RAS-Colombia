  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sensor_msgs__msg__RegionOfInterest * ros_message = static_cast<const sensor_msgs__msg__RegionOfInterest *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sensor_msgs__msg__RegionOfInterest(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sensor_msgs__msg__RegionOfInterest * ros_message = static_cast<sensor_msgs__msg__RegionOfInterest *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sensor_msgs__msg__RegionOfInterest(cdr, ros_message);
}
