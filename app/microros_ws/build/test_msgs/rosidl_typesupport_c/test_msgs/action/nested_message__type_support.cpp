...
static const _NestedMessage_SendGoal_Event_type_support_symbol_names_t _NestedMessage_SendGoal_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_msgs, action, NestedMessage_SendGoal_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_msgs, action, NestedMessage_SendGoal_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, test_msgs, action, NestedMessage_SendGoal_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, test_msgs, action, NestedMessage_SendGoal_Event)() {
  return &::test_msgs::action::rosidl_typesupport_c::NestedMessage_SendGoal_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t NestedMessage_SendGoal_service_type_support_handle = {
  ...
  &NestedMessage_SendGoal_Request_message_type_support_handle,
  &NestedMessage_SendGoal_Response_message_type_support_handle,
  &NestedMessage_SendGoal_Event_message_type_support_handle,
...
static const _NestedMessage_GetResult_Event_type_support_symbol_names_t _NestedMessage_GetResult_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_msgs, action, NestedMessage_GetResult_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_msgs, action, NestedMessage_GetResult_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, test_msgs, action, NestedMessage_GetResult_Event)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, test_msgs, action, NestedMessage_GetResult_Event)() {
  return &::test_msgs::action::rosidl_typesupport_c::NestedMessage_GetResult_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t NestedMessage_GetResult_service_type_support_handle = {
  ...
  rosidl_typesupport_c__get_service_typesupport_handle_function,
  &NestedMessage_GetResult_Request_message_type_support_handle,
  &NestedMessage_GetResult_Response_message_type_support_handle,
  &NestedMessage_GetResult_Event_message_type_support_handle,
  ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_CREATE_EVENT_MESSAGE_SYMBOL_NAME(
    rosidl_typesupport_c,
    test_msgs,
    action,
