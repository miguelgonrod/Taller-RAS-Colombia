...
static const _SetParameters_Event_type_support_symbol_names_t _SetParameters_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rcl_interfaces, srv, SetParameters_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rcl_interfaces, srv, SetParameters_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, rcl_interfaces, srv, SetParameters_Event)),
  }
};
...
{
  return &::rcl_interfaces::srv::rosidl_typesupport_cpp::SetParameters_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rcl_interfaces, srv, SetParameters_Event)() {
  return get_message_type_support_handle<rcl_interfaces::srv::SetParameters_Event>();
}
...
static const rosidl_service_type_support_t SetParameters_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<rcl_interfaces::srv::SetParameters_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<rcl_interfaces::srv::SetParameters_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<rcl_interfaces::srv::SetParameters_Event>(),
